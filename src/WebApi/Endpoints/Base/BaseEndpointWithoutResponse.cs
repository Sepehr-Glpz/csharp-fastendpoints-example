...
public abstract class BaseEndpointWithoutResponse<TRequest> : Endpoint<TRequest, ApiResponse> where TRequest : notnull
{
    ...
    private void ConfigureBase()
    {
        Description(c => c
            .Accepts<TRequest>()
            .Produces<ApiResponse>(StatusCodes.Status200OK, MediaTypeNames.Application.Json, MediaTypeNames.Text.Plain)
